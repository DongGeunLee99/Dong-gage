...
export function createStyles(colors: ColorPalette) {
  return StyleSheet.create({
    ...
    excludedPill: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, backgroundColor: colors.lineLight },
    excludedPillText: { fontFamily: LedgerFonts.bodyBold, fontSize: 10, color: colors.muted },
