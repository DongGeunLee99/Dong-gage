...
export function createStyles(colors: ColorPalette) {
  return StyleSheet.create({
    ...
    categoryIconSq: { width: 30, height: 30, borderRadius: 9, alignItems: 'center', justifyContent: 'center' },
    categoryText: { flex: 1, fontFamily: LedgerFonts.bodySemiBold, fontSize: 14, color: colors.ink },
    merchantInput: {
      flex: 1,
    ...
    fieldHint: { fontFamily: LedgerFonts.body, fontSize: 11.5, color: colors.muted, paddingHorizontal: 2 },
